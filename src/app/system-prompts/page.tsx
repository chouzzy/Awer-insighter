...
export default function SystemPromptsChat() {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await fetch('/api/system-prompts', { // Ou o nome que você deu para sua API Route
                method: 'POST',
                headers: {
            ...
            console.log("Sugestão recebida:", data.suggestion);
